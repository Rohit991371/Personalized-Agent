...
# installed.
TCL_PREFIX='D:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\include'
...
TCL_PACKAGE_PATH='D:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/DSM/GenAI/personalizedAgent/Personalized-Agent/agent\Library\lib\tclstub86.lib'
